          ...
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div class="space-y-6">
              ...
              <div class="bg-gray-50 p-4 rounded-lg">
                <h3 class="text-lg font-semibold text-coral-600 mb-3">Información del Alumno</h3>
                <div class="space-y-2">
              ...
              <div class="bg-gray-50 p-4 rounded-lg">
                <h3 class="text-lg font-semibold text-coral-600 mb-3">Información de la Tutoría</h3>
                <div class="space-y-2">
                  <div class="grid grid-cols-3 gap-2">
