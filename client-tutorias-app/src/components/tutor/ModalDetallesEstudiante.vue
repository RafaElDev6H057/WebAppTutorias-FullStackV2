      ...
      >
        ...
        >
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <h2 class="text-2xl font-bold mb-6 text-[#0A3B76] border-b-2 border-gray-200 pb-2">
              Detalles del Estudiante
            </h2>

            <div class="space-y-6">
              <!-- Información del Alumno -->
              <div class="bg-gray-50 p-4 rounded-lg border-2 border-gray-200 shadow-sm">
                ...
                <div class="space-y-2">
                  <div class="grid grid-cols-3 gap-2">
                    ...
                    <span class="col-span-2 text-gray-900 font-semibold">
              ...
              <div class="bg-gray-50 p-4 rounded-lg border-2 border-gray-200 shadow-sm">
                ...
                <div class="space-y-2">
                  ...
                  <div class="mt-4">
                    ...
                    <p class="text-gray-900 bg-white p-3 rounded-lg border-2 border-gray-200">
            ...
            <div class="mt-6 flex justify-end">
              <button
                @click="$emit('close')"
                class="bg-[#0A3B76] hover:bg-[#083060] text-white font-bold py-2 px-6 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
              >
                Cerrar
              </button>
            </div>
