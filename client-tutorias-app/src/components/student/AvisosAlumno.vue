<template>
  ...
  <div class="space-y-4">
    ...
    <div
      ...
      class="bg-red-50 border-2 border-red-200 rounded-lg p-4 shadow-sm"
    >
    ...
    <div v-else-if="avisos.length > 0" class="space-y-3">
      ...
      >
        <div
          ...
          :key="aviso.id"
          class="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-300 rounded-lg p-5 hover:border-blue-400 hover:shadow-lg transition-all duration-300 group"
        >
            ...
            <div class="flex-1">
              <div class="flex items-center gap-2 mb-2 flex-wrap">
                ...
                <span
                  ...
                  class="px-2.5 py-1 text-xs font-bold bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full shadow-md animate-pulse"
                >
                  NUEVO
                </span>
              </div>
          ...
          <div
            v-if="aviso.link"
            class="mt-4 pt-4 border-t-2 border-blue-200 group-hover:border-blue-300 transition-colors"
          >
            <a
              :href="aviso.link"
              target="_blank"
              rel="noopener noreferrer"
              class="inline-flex items-center gap-2 text-blue-700 hover:text-blue-800 text-sm font-semibold transition-colors duration-200 group/link"
            >
              <svg
    ...
    <!-- ==================== SIN AVISOS ==================== -->
    <div v-else class="bg-gray-100 rounded-lg p-8 text-center border-2 border-gray-200">
      <div
