<template>
  ...
  <div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
      ...
      <div class="flex items-center gap-3">
        ...
        <button @click="showModalExcel = true"
  ...
  <form @submit.prevent="submitForm" class="space-y-6">
    ...
    <Transition enter-active-class="transition ease-out duration-300" enter-from-class="opacity-0"
      enter-to-class="opacity-100" leave-active-class="transition ease-in duration-200" leave-from-class="opacity-100"
      leave-to-class="opacity-0">
      <div v-if="showDeleteModal" class="fixed z-50 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
        aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div class="mt-2">
                    <p class="text-sm text-gray-500">
                      ...
                      <strong>{{ studentToDelete?.nombre }} {{ studentToDelete?.apellido_p }}
                        {{ studentToDelete?.apellido_m }}</strong>? Esta acción no se puede deshacer.
                    </p>
                  </div>
                </div>
              </div>
    ...
    <!-- ==================== MODAL CARGAR EXCEL ==================== -->
    <CargarAlumnosModal :show="showModalExcel" @close="showModalExcel = false" @upload-success="handleUploadSuccess" />
  </div>
</template>
