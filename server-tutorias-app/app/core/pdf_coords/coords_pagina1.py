"""
Coordenadas para posicionamiento de campos en la página 1 del PDF de Reporte Integral.

Define las posiciones exactas (en milímetros) donde se deben renderizar los datos
de los alumnos en la primera página del reporte, usando tamaño carta vertical.
Soporta hasta 11 alumnos por página.
"""
...
coords = {
    "extra": {
        ...
        "departamento": (33 * mm, page_height - 43 * mm),
        "periodo": (129 * mm, page_height - 38 * mm),
        "carrera": (119 * mm, page_height - 43 * mm),
    },
    "alumnos": [
        {
            ...
            "seguimiento1": (seguimiento1_x, page_height - 69 * mm),
            "seguimiento2": (seguimiento2_x, page_height - 69 * mm),
            "seguimiento3": (seguimiento3_x, page_height - 69 * mm),
        ...
        },
        {
            ...
            "seguimiento1": (seguimiento1_x, page_height - 86 * mm),
            "seguimiento2": (seguimiento2_x, page_height - 86 * mm),
            "seguimiento3": (seguimiento3_x, page_height - 86 * mm),
        ...
        },
        {
            ...
            "seguimiento1": (seguimiento1_x, page_height - 104 * mm),
            "seguimiento2": (seguimiento2_x, page_height - 104 * mm),
            "seguimiento3": (seguimiento3_x, page_height - 104 * mm),
        ...
        },
        {
            ...
            "seguimiento1": (seguimiento1_x, page_height - 121 * mm),
            "seguimiento2": (seguimiento2_x, page_height - 121 * mm),
            "seguimiento3": (seguimiento3_x, page_height - 121 * mm),
        ...
        },
        {
            ...
            "seguimiento1": (seguimiento1_x, page_height - 138 * mm),
            "seguimiento2": (seguimiento2_x, page_height - 138 * mm),
            "seguimiento3": (seguimiento3_x, page_height - 138 * mm),
        ...
        },
        {
            ...
            "seguimiento1": (seguimiento1_x, page_height - 155 * mm),
            "seguimiento2": (seguimiento2_x, page_height - 155 * mm),
            "seguimiento3": (seguimiento3_x, page_height - 155 * mm),
        ...
        },
        {
            ...
            "seguimiento1": (seguimiento1_x, page_height - 172 * mm),
            "seguimiento2": (seguimiento2_x, page_height - 172 * mm),
            "seguimiento3": (seguimiento3_x, page_height - 172 * mm),
        ...
        },
        {
            ...
            "seguimiento1": (seguimiento1_x, page_height - 190 * mm),
            "seguimiento2": (seguimiento2_x, page_height - 190 * mm),
            "seguimiento3": (seguimiento3_x, page_height - 190 * mm),
        ...
        },
        {
            ...
            "seguimiento1": (seguimiento1_x, page_height - 207 * mm),
            "seguimiento2": (seguimiento2_x, page_height - 207 * mm),
            "seguimiento3": (seguimiento3_x, page_height - 207 * mm),
        ...
        },
        {
            ...
            "seguimiento1": (seguimiento1_x, page_height - 224 * mm),
            "seguimiento2": (seguimiento2_x, page_height - 224 * mm),
            "seguimiento3": (seguimiento3_x, page_height - 224 * mm),
        ...
        },
        {
            ...
            "seguimiento1": (seguimiento1_x, page_height - 241 * mm),
            "seguimiento2": (seguimiento2_x, page_height - 241 * mm),
            "seguimiento3": (seguimiento3_x, page_height - 241 * mm),
